package com.lucifer.tipcalculatormatarialthemes
...
import com.lucifer.tipcalculatormatarialthemes.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun displayTotalAmount(totalAmount: Double) {
